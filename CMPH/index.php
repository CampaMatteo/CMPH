  ...
  <body>
    ...
    <div class="row justify-content-center">
        <div class="col text-center">
            ...
            <a href="#foto" class="hover-violet">si, faccio foto.</a>
...
<br><br><br><br>
    <section id="foto">
        ...
        <div class="row justify-content-center">
            <div class="col text-center">
                <img src="dj.JPG" class="responsive" alt="Girl in a jacket">
            </div>
            <div class="col text-center">
        ...
        <div class="row justify-content-center">
            <div class="col text-center">
                <img src="canto.JPG" class="responsive" alt="Girl in a jacket">
            </div>
            <div class="col text-center">
                <img src="festa.JPG" class="responsive" alt="Girl in a jacket">
            </div>
            
            <div class="col text-center">
                <img src="batteria.JPG" class="responsive" alt="Girl in a jacket">
            </div>
        </div>
